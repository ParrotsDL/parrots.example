...
backbone_channels = [8,16,24,48]
cls_kernel_channels = 128
cls_search_channels = 64
reg_kernel_channels = 64
reg_search_channels =64
...
anno_root = 's3://parrots_model_data/mmtrack/jsons/'
data = dict(
    samples_per_gpu=64,
    workers_per_gpu=4,
    train=dict(
