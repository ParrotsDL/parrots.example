...
data_root = '/mnt/lustre/share_data/parrots_model_data/mmocr/data/icdar2015/'
ceph_data_root = 's3://parrots_model_data/mmocr/data/icdar2015/'
img_norm_cfg = dict(
...
train_pipeline = [
    ...
    dict(
        ...
        keep_ratio=False),
    dict(type='GenPANetTargets'),
    dict(type='RandomFlip', flip_ratio=0.5, direction='horizontal'),
    dict(type='RandomRotate'),
    dict(type='RandomCropInstances', target_size=(736, 736)),
