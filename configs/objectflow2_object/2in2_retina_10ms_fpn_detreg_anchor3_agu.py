...
task_prefix = {'bbox_head.retina_cls': 'reg',
               'bbox_head.retina_reg': 'reg'}
...
test_datasets = [
    ...
    #     img_prefix='sh41:/mnt/lustre/share_data/zhangao/rotated_object/',
    #     with_ignore_bboxes=True,  # gt_bboxes_ignore
    #     detect_task=detect_task,  # start from 0
    #     extra_task=extra_task,
    #     pipeline=test_pipeline),
    ...
    #     img_prefix='sh1984:/mnt/lustre/share_data/detection_dataset_zqm/phone_v0.1.0/mnt/lustre/zhangao/dataset_chengwenhao/detection_data/phone_data/p2/phone2/bmw_collection/20190914_0916_all_new/rotated_images_crop/',
    #     with_ignore_bboxes=True,  # gt_bboxes_ignore
    #     detect_task=detect_task,  # start from 0
    #     extra_task=extra_task,
    #     pipeline=test_pipeline),
    ...
    #     img_prefix='sh41:/mnt/lustre/share_data/zhangao/object_oms_image/',
    #     with_ignore_bboxes=True,  # gt_bboxes_ignore
    #     detect_task=detect_task,  # start from 0
    #     extra_task=extra_task,
    #     pipeline=test_pipeline),
...
data = dict(
    ...
    train=dict(
        ...
        img_prefix=[
            ...
            '/mnt/lustre/share_data/parrots_model_data/objectflow_object/detection_dataset_zqm/rotated_object/',
            # 'sh41:/mnt/lustre/share_data/zhangao/rotated_object/',
            # 'sh41:/mnt/lustre/share_data/zhangao/rotated_object/',
            # 'sh41:/mnt/lustre/share_data/zhangao/rotated_object/',
            # 'sh1984:/mnt/lustre/share_data/detection_dataset_zqm/objects365/train/',
            # 'sh1984:/mnt/lustre/share_data/detection_dataset_zqm/hoi_dataset/rotated_pro_image/',
            # 'sh1985:/mnt/lustre/share_data/zhangao/object_oms_image/',
        ],
        with_ignore_bboxes=True,  # gt_bboxes_ignore
        detect_task=detect_task,  # start from 0
        extra_task=extra_task,
