...
task_prefix = dict({
    'relation_neck.lateral_convs.0': 'relation',
    'relation_neck.lateral_convs.1': 'relation',
    'relation_neck.lateral_convs.2': 'relation',
    'relation_neck.d_conv': 'relation',
    'relation_neck.fpn_convs.0': 'relation',
    'relation_neck.fpn_convs.1': None,
    'relation_neck.fpn_convs.2': None,
    'relation_neck.fpn_convs.3': None,
    'relation_neck.fpn_convs.4': None,
...
log_level = 'INFO'
load_from = '/mnt/lustre/share_data/parrots_model_ckpt/objectflow_child/multitask_base/relation.pth'
resume_from = None
...
work_dir = './workdir/multitask_void_bag_doll_1116_0.2_new/_task3'
gpu_ids = range(0, 1)
