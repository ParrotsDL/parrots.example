...
# model settings
model = dict(backbone=dict(in_channels=10),cls_head=dict(num_classes=101, init_std=0.001))

# dataset settings
dataset_type = 'RawframeDataset'
data_root = '/mnt/lustre/share/openmmlab/datasets/action/ucf101/flow/'
data_root_val = '/mnt/lustre/share/openmmlab/datasets/action/ucf101/flow/'
split = 1  # official train/test splits. valid numbers: 1, 2, 3
ann_file_train = f'/mnt/lustre/share/openmmlab/datasets/action/ucf101/ucf101_train_split_3_rawframes.txt'
...
work_dir = f'./work_dirs/tsn_r50_1x1x3_75e_ucf101_split_{split}_flow/'
