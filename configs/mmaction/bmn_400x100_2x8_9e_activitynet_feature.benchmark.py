...
data_root = '/mnt/lustre/share_data/jiaomenglei/model_pool_data/mmaction_data/ActivityNet/activitynet_feature_cuhk/csv_mean_100/'
data_root_val = '/mnt/lustre/share_data/jiaomenglei/model_pool_data/mmaction_data/ActivityNet/activitynet_feature_cuhk/csv_mean_100/'
ann_file_train = '/mnt/lustre/share_data/jiaomenglei/model_pool_data/mmaction_data/ActivityNet/anet_anno_train.json'
...
evaluation = dict(interval=1, metrics=['AR@AN'], key_indicator='AR@100')
