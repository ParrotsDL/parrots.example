...
data = dict(
    ...
    train=dict(
        ...
        ann_file=[
            ...
            # mot_root + 'face_detection/new_annos/surv_20200412.pkl',
            mot_root + 'new_formart/pedestrianTrainIgnore_20201102.pkl',
        ],
        img_prefix=[
            ...
            # '/mnt/lustre/share/zhangqiming/wangliming/backup_data/surv_data/surveillance_data/',
            'sh1985:s3://zhangao/full_body/pedestrian_data/',
        ],
        with_ignore_bboxes=True,
        detect_task=detect_task,
        extra_task=extra_task,
