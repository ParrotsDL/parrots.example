...
data = dict(
    ...
    train=dict(
        ...
        ann_file=[
            ...
            # '/mnt/lustre/share/lindelv/data/mot/mot16/pkl/train.pkl',
            # '/mnt/lustre/share/lindelv/data/mot/mot20/pkl/train.pkl',
            # '/mnt/lustre/share/lindelv/data/mot/emb600id/pkl/train.pkl',
            # '/mnt/lustre/share/lindelv/data/mot/prw/pkl/train.pkl',
        ],
        img_prefix=[
            'sh1984:s3://parrots_model_data/objectflow_mot/mot/mnt/lustre/share/lindelv/data/mot/',
            # '/mnt/lustre/share/lindelv/data/mot/',
            # '/mnt/lustre/share/lindelv/data/mot/',
            # '/mnt/lustre/share/lindelv/data/mot/',
            # '/mnt/lustre/share/lindelv/data/mot/',
        ],
