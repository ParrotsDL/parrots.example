...
losses = dict(
    losses_info = [
        dict(type='BBoxCIOULoss',
            loss_weight=2.0,
            name='ciou'),
        dict(type='BBoxPointLoss',
            base_loss=dict(type='SoftWingLoss',thres1=1.0,thres2=10.0,curvature=0.3),
            loss_weight=2.0,
            name='point'),
        dict(type='BBoxPerturbLoss',
