    ...
    main_branch=dict(
        ...
        backbone=dict(
            ...
            layers=[dict(type="InterpolateLayer",output_size=[128,128]),
                    ...
                    dict(type='AvgPool', kernel_size=2, stride=2, padding=0), # 32
    ...
    lip_branch=dict(
        ...
        backbone=dict(
            ...
            layers=[dict(type='Conv2dBlock', inchannel=lb_backbone_channels[0],
                    ...
                    dict(type='SELayer',
                         outchannel=backbone_channels[6],feature_size=5, reduction=4),
                    ...
                    dict(type='SELayer',
                         outchannel=backbone_channels[7],feature_size=3, reduction=4)], # 3
        ),
        regression_head=dict(
            type='FCHead',
            ...
            layers=[dict(type='Conv2dBlock',  inchannel=lb_backbone_channels[7],
                    ...
                    dict(type='SELayer',
                         outchannel=backbone_channels[8],feature_size=3, reduction=4),],
            fc_number=3,
...
losses = dict(
    losses_info = [
        dict(type = 'LandmarkLoss',
             base_loss=dict(type="SoftWingLoss", thres1=0.5),
             branch = 'mouth',
             part = ['lip_64pt'],
             weight = 128),
        dict(type = 'LandmarkLoss',
        ...
        dict(type = 'DiffLoss',
             ...
             branch = 'mouth',
             part = ['lip_64pt'],
             close_weight=10.,use_close_weight=True,
             weight = 6),
