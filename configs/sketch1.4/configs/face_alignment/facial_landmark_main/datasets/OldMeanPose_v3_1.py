...
# lmdb config
train_db_info=dict(
    lmdb_path="/mnt/lustre/chenzukai/roi-sketch/lmdb_path/sketch/mixlmdb_282_v3.0_oldmeanpose_full_0107/",
    lmdb_name="Train",
...
data = dict(
    ...
    val=dict(
        ...
        data_infos=[
            ...
            #     repeats=1,
            #     json_file_list="/mnt/lustre/lisiying1/data/CropFace/OldMeanPose/Validate/OccMake/common_hand/json_filelist.txt",
            #     image_rootpath="s3://ARFace.facial_landmark_bucket/CropFace/OldMeanPose/Validate/OccMake/common_hand/Image/",
            #     json_rootpath="/mnt/lustre/lisiying1/data/CropFace/OldMeanPose/Validate/OccMake/common_hand/Label/",
            #     source="ceph",
            #     ceph_clustre="sh40_hdd"),
            # dict(
            #     dataset_name="common_mic",
            #     repeats=1,
            #     json_file_list="/mnt/lustre/lisiying1/data/CropFace/OldMeanPose/Validate/OccMake/common_mic/json_filelist.txt",
            #     image_rootpath="s3://ARFace.facial_landmark_bucket/CropFace/OldMeanPose/Validate/OccMake/common_mic/Image/",
            #     json_rootpath="/mnt/lustre/lisiying1/data/CropFace/OldMeanPose/Validate/OccMake/common_mic/Label/",
            #     source="ceph",
            #     ceph_clustre="sh40_hdd")
        ],
	    data_versions=dict(
