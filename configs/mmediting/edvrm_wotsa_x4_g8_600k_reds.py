...
data_root = '/mnt/lustre/share_data/jiaomenglei/model_pool_data/mmediting_data/SR/datasets/REDS/'
data_root_val = None
ceph_data_root = 's3://parrots_model_data/mmediting_data/SR/datasets/REDS/'
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder= data_root + 'train_sharp_bicubic',
            gt_folder= data_root + 'train_sharp',
            ann_file='/mnt/lustre/share_data/jiaomenglei/model_pool_data/mmediting_data/SR/datasets/REDS/meta_info_REDS_GT.txt',
            num_input_frames=5,
...
# runtime settings
dist_params = dict(backend='nccl', port=20005)
log_level = 'INFO'
