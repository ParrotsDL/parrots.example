...
validate_pipeline = [
    ...
    dict(type="LabelToTensor", keys=['landmark', 'weight']),
    dict(type="Collect", image_keys=['origin_image'], label_keys=['landmark', 'weight'])
]
# test_pipeline = [
...
# lmdb config
train_db_info=dict(
    lmdb_path="/mnt/lustre/chenzukai/sketch-latest/lmdb_path/mixlmdb_106_v1.2.4/",
    lmdb_name="Train_meitu",
    image_type_in_lmdb="path"
)

validate_db_info=dict(
    lmdb_path="/mnt/lustre/liutinghao/base_training_code/lmdb_path/sketch/mixlmdb_106_v1.2.4/",
    lmdb_name="Validate",
    image_type_in_lmdb="path"
)
