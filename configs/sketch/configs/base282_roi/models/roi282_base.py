...
metrics = dict(
        metric_alignment = [dict(type = 'nme282', name='face_106pt'),
                            dict(type = 'nme282', name='nose_15pt'),
                            dict(type = 'nme282', name='lip_64pt'),
                            dict(type = 'nme282', name='eyelid_24pt'),
                            dict(type = 'nme282', name='iris_19pt'),
                            dict(type = 'nme282', name='eyebrow_13pt'),
                            dict(type = 'nme282', name='roi_part'),
                            dict(type = 'nme282', name='contour_fitting')],
