...
if [[ $name == "siamrpnpp" ]]; then
    ...
    /mnt/lustre/share_data/parrots_model_data/mmtrack/jsons/occ_videos/occ_wangchao0611.json \
    ...
    /mnt/lustre/share_data/parrots_model_data/mmtrack/test_data/occlusion_test/useful_video/testset_ours/json_label/final_image/ \
    ${EXTRA_ARGS} \
